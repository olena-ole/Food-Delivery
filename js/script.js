...
window.addEventListener('DOMContentLoaded', () => {
    ...
    let sex = 'female', //default value
        height, weight, age,
        ratio = 1.375; //default value
    ...
    function getStaticInformation(parentSelector, activeClass) {
        const elements = document.querySelectorAll(`${parentSelector} div`); //got all divs inside parent selector
    ...
    getStaticInformation('.calculating__choose_big', 'calculating__choose-item_active'); //selector starts with dot
